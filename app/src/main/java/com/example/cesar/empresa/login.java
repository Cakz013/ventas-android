...
/*
Este es nuestro inicio de la apk gracias a esta pantalla de logueo es que inicia nuestra aplicacion.
desde aqui podremos observar el corazon de nuestra apk.
 */
    ...
    private void initAccesoDirectoApp() {
        if (UtilsAC.crearAccesoDirecto(this, login.class,
    ...
    private void ingresarHelper() {
       ...
       /* Usuario userAdmitido = /*utenticacion.getUsuarioAutenticadoOffLine(this,
        ...
        if (userAdmitido != null) {
          ...
          esta linea es para el gps   inicializarTrackEnSegundoPlano();
*/

            Intent intent = new Intent(this, FormOperacionLuegoLogin.class);
            intent.putExtra("idusuario", "aqui va el usuario");
            MLog.d("Inbiciando actividad: " + FormOperacionLuegoLogin.class);

            startActivity(intent);
/*
        } else {
            MLog.d("Usuario o clave no v�lidos. Acceso denegado.");
    ...
    public void dialogoPedirIdusuarioActualizar(View vista) {
        ...
        final PostDownloadAction postAccionExito = new PostDownloadAction() {
            ...
            public void ejecutar() {
                Forms.enable(login.this, R.id.btIngresar, true);
...
//        initAccionesPrimeraVez();
    ...
    /*void hacerUpdateSiNecesarioGUI_completar(final Context context) {
        ...
        if ((!lastUpdateOk) || pasoMasDelTiempoStockValido()) {
            ...
            Forms.enable(login.this, R.id.btIngresar, false);
