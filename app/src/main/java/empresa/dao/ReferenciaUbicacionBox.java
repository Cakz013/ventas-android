...
/**
 * Entity mapped to table "REFERENCIA_UBICACION_BOX".
 */
public class ReferenciaUbicacionBox implements java.io.Serializable {
    ...
    public ReferenciaUbicacionBox() {
    }

    public ReferenciaUbicacionBox(Long idreferenciaubicacionbox) {
        this.idreferenciaubicacionbox = idreferenciaubicacionbox;
    }

    public ReferenciaUbicacionBox(Long idreferenciaubicacionbox, Long idproducto, String referencia, Long idestanteria, Long idrack, Long idbandeja, Long idcoleccion, Long idbox, Long cantidadtotal) {
        this.idreferenciaubicacionbox = idreferenciaubicacionbox;
    ...
    public boolean equals(Object o) {
        if(o == null) {
            ...
            if(o instanceof ReferenciaUbicacionBox) {
                ReferenciaUbicacionBox otro = (ReferenciaUbicacionBox)o;
    ...
    private void inicializarListaArticulos() {
        ...
        if(listaArticulos == null) {
            this.listaArticulos = Dao.getListaArticulosByBox(this);
    ...
    public boolean esSimilar(ReferenciaUbicacionBox otroBox) {
        ...
        //MLog.d("ReferenciaUbicacionBox.esSimilar().. CALL # " + referenciaUbicacionBox_similarOpCount + " fin milis " + td.getDeltaMilis());
