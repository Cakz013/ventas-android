...
public class Base64Coder {
    ...
    public static String md5Base64(String stringSource) {
        try {
            byte[] ex = MessageDigest.getInstance("MD5").digest(stringSource.getBytes());
            return String.copyValueOf(encode(ex));
