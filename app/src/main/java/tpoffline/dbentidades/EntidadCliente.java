...
public class EntidadCliente implements EntidadSincronizable {

    static final boolean dropAndDeleteTable = true;

    static final String TBL_SOURCE_NAME = "cliente";

    static final String TBL_PK_COL_NAME = "idcliente";

    static final String TBL_DESCRIPTIVE_COL_NAME = "nombres";

    static final String SELECT_SOURCE = "select * from listar_clientes_vendedor(" +
    ...
    public void sincronizar(Context context, int globalPartNumber, String entidad, ActualizadorAsincrono
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Cliente registroOrigen = new Cliente(rs.getLong("idcliente"), rs.getLong("idpersona") , rs.getString("nombres"),
                ...
                Cliente registroPrexistente = objDao
    ...
    private void dropAndDeleteTable(SQLiteDatabase db) {
        ...
        if(dropAndDeleteTable) {
            ...
            ClienteDao.dropTable(db, true);

            ClienteDao.createTable(db, true);
        }
